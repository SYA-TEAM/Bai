...
exports.Curve = {
    ...
    signSync: (privateKey, buf) => libsignal.curve.calculateSignature(privateKey, buf),
    sign: async (privateKey, buf) => {
        return new Promise((resolve, reject) => {
            setImmediate(() => {
                try {
                    const sig = libsignal.curve.calculateSignature(privateKey, buf);
...
const signedKeyPair = async (identityKeyPair, keyId) => {
    const preKey = exports.Curve.generateKeyPair();
    const pubKey = (0, exports.generateSignalPubKey)(preKey.public);
    const signature = await exports.Curve.sign(identityKeyPair.private, pubKey);
